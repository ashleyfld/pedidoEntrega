...
try:
    conn = mysql.connector.connect(
           host='ashleyfld.mysql.pythonanywhere-services.com',
           user='ashleyfld',
           password='mysqlroot'
      )
...
cursor.execute("DROP DATABASE IF EXISTS `ashleyfld$pedidoEntrega`;")

cursor.execute("CREATE DATABASE `ashleyfld$pedidoEntrega`;")

cursor.execute("USE `ashleyfld$pedidoEntrega`;")
...
cursor.execute('select * from ashleyfld$pedidoEntrega.usuarios')
print(' -------------  Usuarios:  -------------')
...
cursor.execute('select * from ashleyfld$pedidoEntrega.productos')
print(' -------------  Productoss:  -------------')
